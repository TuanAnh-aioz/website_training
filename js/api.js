...
const API_TOKEN = "8bda83f76964192c7f1e435b887c1b74359af0347721458610cdae3654a433b6";
...
async function getTrainingTaskLogs(taskId, offset = 0, limit = 2) {
    const res = await fetch(`${API_HOST}/training/task/${taskId}/logs?offset=${offset}&limit=${limit}`, {
        method: "GET",
...
export { createTrainingTask, getTrainingTaskLogs, getTrainingTaskResult, getNodeTrainingAvailable};